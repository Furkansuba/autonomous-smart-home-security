...
async function seedTelemetry() {
  await TelemetrySummary.create([
    ...
    },
    {
      ...
      motion_detected: false,
      reed_open: false,
      occurred_at: minutesBefore(20),
      received_at: minutesBefore(20),
    },
  ]);
...
async function seedOverrides() {
  await OverrideRequest.create([
    ...
    {
      override_id: 'ovr_demo_valve_open_failed_001',
      device_id: 'esp32_demo_garage_01',
      requested_by: 'usr_admin_001',
      actuator_id: 'valve_garage_01',
      action: 'valve_open',
      reason: 'Demo valve open request on degraded device.',
      status: 'failed',
